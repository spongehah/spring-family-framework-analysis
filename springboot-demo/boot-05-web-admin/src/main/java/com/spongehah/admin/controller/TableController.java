...
import com.spongehah.admin.service.AccountService;
...
public class TableController {
    ...
    @GetMapping("/acct")
    @ResponseBody
    public String getAcctById(@RequestParam("id") Long id) {
        return accountService.getAccountById(id).toString() + personName;
    }
